...
public class DynamicCompilerUtil {
                    ...
                    public boolean accept(File pathname) {
                        if (pathname.isDirectory()) {
                            ...
                            if (name.endsWith(".jar") ? true : false) {
                                jars = jars + pathname.getPath() + pathSeparator;
                                return true;
                            }
                            return false;
                        }
    ...
    public static void main(String[] args) {
        try {
            ...
            String filePath = "/home/yishi/IDEA/code_generator/target/code_generator/WEB-INF/classes/exampleSource/";
            String sourceDir = "/home/yishi/IDEA/code_generator/target/code_generator/WEB-INF/classes/exampleSource/";
            String jarPath = "/home/yishi/IDEA/code_generator/target/code_generator/WEB-INF/lib";
            String targetDir = "/home/yishi/classes";
